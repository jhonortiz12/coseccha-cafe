...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (_isLogin) {
        validationError = AuthService.validateLoginFields(
          email: email,
          password: password,
        );
      } else {
        validationError = AuthService.validateRegisterFields(
          name: name,
          email: email,
          password: password,
        );
      ...
      // Verificar si hay una finca seleccionada previamente
      final fincaData = await FincaPreferencesService.getFincaSeleccionada();
      
      if (fincaData != null) {
        // Si hay finca guardada, ir directamente a MainNavigationPage
        Get.offAll(() => MainNavigationPage(
          fincaId: fincaData['id']!,
          fincaNombre: fincaData['nombre']!,
        ));
      } else {
        // Si no hay finca, ir a ListaFincasPage para que seleccione una
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        hintText: _isLogin ? 'correo@gmail.com' : 'tucorreo@gmail.com',
                        hintStyle: TextStyle(color: Colors.grey[400]),
                        prefixIcon: Icon(Icons.email_outlined, color: Colors.grey[400]),
                        suffixIcon: !_isLogin ? Tooltip(
                          message: 'Debe ser una cuenta de Gmail',
